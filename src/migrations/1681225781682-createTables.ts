...
export class CreateTables1681225781682 implements MigrationInterface {
    name = 'CreateTables1681225781682'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "cpf" character varying NOT NULL, "phone" character varying(11) NOT NULL, "password" character varying NOT NULL, "birthday" TIMESTAMP NOT NULL, "description" character varying NOT NULL, "buyer" boolean NOT NULL, "addressId" uuid, CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
