...
export class CreateTable1683050216903 implements MigrationInterface {
    name = 'CreateTable1683050216903'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vehicles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying NOT NULL, "model" character varying NOT NULL, "year" character varying NOT NULL, "fuel" character varying NOT NULL, "color" character varying NOT NULL, "mileage" integer NOT NULL, "price" integer NOT NULL, "fipe" integer NOT NULL, "description" character varying NOT NULL, "published" boolean NOT NULL, "userId" uuid, CONSTRAINT "PK_18d8646b59304dce4af3a9e35b6" PRIMARY KEY ("id"))`);
