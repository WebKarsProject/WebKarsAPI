...
const listAllVehiclesController = async (req: Request, res: Response) => {
  const vehicle = await listAllVehicleService(req)
...
export { createVehicleController, listAllVehiclesController, getVehicleUserController, updateVehicleController, deleteVehicleController, getVehicleController }
